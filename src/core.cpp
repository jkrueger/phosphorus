...
const material_t::p glass(new glass_t({0.5, 0.5, 0.5}));

int main(int argc, char** argv) {
  film_t film(WIDTH, HEIGHT);
  lenses::pinhole_t lens;
  auto light0  = light_t::p(new light_t(shadable_t::p(new sphere_t({1,1,-3}, 0.25, white)), L));
  ...
  auto sphere2 = light_t::p(new light_t(shadable_t::p(new sphere_t({-1, -0.75, -1}, 0.25, pink)), {0.8,0.4,0.7}));
